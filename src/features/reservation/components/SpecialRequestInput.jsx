...
const SpecialRequestInput = () => {
    ...
    return (
        <section className={`flex flex-col gap-6 p-6 box-shadow rounded`}>
            <h3 className={`font-medium text-xl text-c26`}> Special Requests <span className={`text-base text-c43
             font-normal`} >(optional)</span> </h3>
            <p className={`text-c43 text-base`} > Special requests cannot be guaranteed – but the property will do its best to meet your needs. You can always make a special request after your booking is complete! </p>
